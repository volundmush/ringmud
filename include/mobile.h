...
namespace ring::mobile {
    ...
    extern std::function<void(vnum, entt::entity ent)> on_create_mobile, on_delete_mobile, on_make_mobile;
    ...
    extern std::function<void(entt::entity, std::string)> handle_mobile_command;
