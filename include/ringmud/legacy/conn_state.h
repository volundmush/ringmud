...
#ifndef CIRCLE_INCLUDE_LEGACY_CONN_STATE
#define CIRCLE_INCLUDE_LEGACY_CONN_STATE

/* Modes of connectedness: used by session_data.state */
#define CON_PLAYING     0    /* Playing - Nominal state		*/
#define CON_CLOSE     1    /* User disconnect, remove puppet.	*/
...
#define CON_DISCONNECT     17    /* In-game link loss (leave puppet)	*/
...
#endif //CIRCLE_INCLUDE_LEGACY_CONN_STATE
