...
#ifndef CIRCLE_INCLUDE_LEGACY_MOB_FLAGS
#define CIRCLE_INCLUDE_LEGACY_MOB_FLAGS
...
#define MOB_NOSCAVENGER        2  /* Mob won't pick up items from room_table*/
...
#endif //CIRCLE_INCLUDE_LEGACY_MOB_FLAGS
