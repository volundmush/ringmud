...
#ifndef CIRCLE_INCLUDE_LEGACY_PREFERENCE
#define CIRCLE_INCLUDE_LEGACY_PREFERENCE
...
#define PRF_BUILDWALK   24 /* Build new room_table when walking		*/
...
#endif //CIRCLE_INCLUDE_LEGACY_PREFERENCE
