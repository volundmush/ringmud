...
namespace ring::net {
    ...
    public:
        ...
        // added from circle project:
        void process_input();
        void onStart();
        void send(const std::string &str);
        void sendColor(const std::string &str);
        bool canLoginAsUser(entity_t u);
        void loginAsUser(entity_t u, bool copyover = false);
        bool canUseCharacter(char_data *ch);
        void useCharacter(char_data *ch);
        void setParser(parser::ConnectionParser *p);
        void leaveSession();
        void logout();
        void close(bool expected);
